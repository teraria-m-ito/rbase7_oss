...
export basename="rake_lti_reflection_participant_import"
...
rake RAILS_ENV=production RBASE_LOG_NAME=batch_production lti:import_lti_reflection_partificants[reflection_participant.xlsx]
rake_exit_code=$?
